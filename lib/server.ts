...
import {AppError,modelConfig,transcriptionEnabled,runModel,type ModelEnvironment} from './model';
...
export const transcriptionReady=()=>transcriptionEnabled(bindings());
